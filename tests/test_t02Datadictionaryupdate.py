...
class TestT02Datadictionaryupdate():
  ...
  def test_t02Datadictionaryupdate(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.invisibility_of_element_located((By.CSS_SELECTOR, "div[aria-describedby=\"div_add_field\"]")))
    self.driver.find_element(By.LINK_TEXT, "My Projects").click()
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, "input[name=\"update[dictionary]\"]")
    assert len(elements) > 0
    element = self.driver.find_element(By.CSS_SELECTOR, "input[name=\"update[dictionary]\"]")
