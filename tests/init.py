...
class Test_init:
  ...
  def test_init(self):
    ...
    self.driver.find_element(By.XPATH, "//table[@id='table-template_projects_list']//tr[contains(.,'Longitudinal Database (2 arms)')]//input").click()
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "#external-modules-enabled tr[data-module=\"project_deployment\"]")))
    ...
    self.driver.find_element(By.CSS_SELECTOR, "button[onclick*=\"copy_project_form.php\"]").click()
    self.driver.execute_script("$('#app_title').val('Project Deployment Test 2')")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"online_designer.php\"]").click()
    self.driver.execute_script("$('#south').remove()")
    self.driver.find_element(By.CSS_SELECTOR, "button[onclick*=\"Surveys/edit_info.php\"][onclick*=\"patient_morale_questionnaire\"]").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    self.driver.execute_script("$('#south').remove()")
    self.driver.find_element(By.ID, "surveySettingsSubmit").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "input[name=\"source-server\"]")))
    ...
    self.driver.execute_script("$('input[name=\"source-server\"]').val(window.location.href.replace(/\\/redcap_v[0-9].*/,''))")
    self.driver.execute_script("$('#south').remove();$('input[name=\"source-project\"]').val(sessionStorage.getItem('sourceproject'))")
