...
class TestT07Formdisplaylogicupdate():
  ...
  def test_t07Formdisplaylogicupdate(self):
    ...
    dropdown = self.driver.find_element(By.NAME, "outer-list[0][form-name][]")
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, "input[name=\"update[fdl]\"]")
    assert len(elements) > 0
    element = self.driver.find_element(By.CSS_SELECTOR, "input[name=\"update[fdl]\"]")
